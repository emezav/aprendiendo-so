...
/** @brief Inicio de la region fisica principal disponible para asignacion. */
extern unsigned int memory_start;

/** @brief Tamano en bytes de la region fisica principal disponible. */
extern unsigned int memory_length;
...
/**
 * @brief Retorna la direccion de inicio de la region fisica disponible.
 * @return Direccion fisica inicial de la region principal disponible.
 */
unsigned int physmem_get_start(void);

/**
 * @brief Retorna el tamano en bytes de la region fisica disponible.
 * @return Tamano total en bytes de la region principal disponible.
 */
unsigned int physmem_get_length(void);
