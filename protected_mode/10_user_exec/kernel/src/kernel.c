...
void kernel_enter_monitor_loop(void) {
    ...
    /* Si en el futuro se reingresa al monitor desde una interrupcion o desde
     * una salida de modo de usuario, asegurar que el timer y el teclado puedan
     * volver a despertarlo. */
    inline_assembly("sti");
