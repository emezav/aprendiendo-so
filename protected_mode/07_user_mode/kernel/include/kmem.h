 ...
 * @param start Dirección de la primera página de la región
...
/**
 * @brief Retorna la primera direccion virtual util del espacio asignable del
 * kernel.
 * @return Inicio del espacio virtual asignable del kernel.
 */
unsigned int kmem_get_start(void);

/**
 * @brief Retorna el final exclusivo del espacio virtual asignable del kernel.
 * @return Final exclusivo del espacio virtual asignable del kernel.
 */
unsigned int kmem_get_end(void);
