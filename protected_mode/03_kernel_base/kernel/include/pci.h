...
/**
 * @brief Encabezado del espacio de configuración de un dispositivo PCI, según PCI
 * 2.3
 */
...
/**
 * @brief Estructura de los primeros 56 bytes del espacio de configuración de un
...
/**
 *  @brief Tipo de datos de un dispositivo PCI
 */
typedef struct {
    unsigned char bus;
    unsigned char slot;
