...
/* @brief Bit U/S para una entrada accesible desde userland. */
#define PG_USER 4
...
/** @brief Primera direccion virtual util reservada para futuras paginas de usuario. */
#define USER_VIRT_START 0x00400000

/** @brief Inicio exclusivo del espacio virtual reservado al kernel. */
#define USER_VIRT_END KERNEL_VIRT_OFFSET
...
/** @brief Redondea una dirección dada al inicio de la siguiente página o la misma si ya está alineada. */
 ...
 * @param vaddr Direccion virtual de la pagina de usuario.
...
/** @brief Verifica si una direccion virtual cae dentro del rango provisional de userland.
 * @param vaddr Direccion virtual a validar.
 * @return 1 si pertenece al rango provisional de userland, 0 en caso contrario.
 */
