...
/** @brief Interrupcion reservada para la futura prueba controlada de userland. */
#define USERMODE_TEST_INTERRUPT 0x81
...
/** @brief Selector del descriptor de codigo del kernel. */
extern unsigned short kernel_code_selector;

/** @brief Selector del descriptor de datos del kernel. */
extern unsigned short kernel_data_selector;

/** @brief Selector del descriptor de codigo reservado para userland. */
extern unsigned short user_code_selector;

/** @brief Selector del descriptor de datos reservado para userland. */
extern unsigned short user_data_selector;
